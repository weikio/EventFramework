...
namespace Weikio.EventFramework.EventFlow.CloudEvents
{
    public static class EventFlowBuilderSecurityExtensions
    {
        ...
        public static CloudEventsChannelBuilder Decrypt(this CloudEventsChannelBuilder builder, string privateKey = "", string privateKeyPath = "", string deadLetterChannel = "")
        {
            var options = new DecryptorComponentOptions() { PrivateKey = privateKey, PrivateKeyPath = privateKeyPath, DeadletterChannel = deadLetterChannel};
        ...
        public static CloudEventsChannelBuilder Encrypt(this CloudEventsChannelBuilder builder, string publicKey = "", string publicKeyPath = "")
        {
            var options = new EncryptorComponentOptions() { PublicKey = publicKey, PublicKeyPath = publicKeyPath };
