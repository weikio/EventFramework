...
namespace Weikio.EventFramework.Plugins.AzureServiceBus
{
    public class AzureServiceBusEventSource : BackgroundService
    {
        ...
        public AzureServiceBusEventSource(ILogger<AzureServiceBusEventSource> logger, ICloudEventPublisher cloudEventPublisher, AzureServiceBusConfiguration configuration)
        {
            _logger = logger;
