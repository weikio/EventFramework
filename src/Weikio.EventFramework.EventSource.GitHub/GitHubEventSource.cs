...
{
    public class GitHubEventSource : IApiEventSource<GitHubConfiguration>
    {
        private readonly IHttpContextAccessor _contextAccessor;
        private readonly ILogger<GitHubEventSource> _logger;

        public GitHubConfiguration Configuration { get; set; }

        public GitHubEventSource(ILogger<GitHubEventSource> logger, IHttpContextAccessor contextAccessor)
        {
