...
namespace Weikio.EventFramework.EventSource.DataSources.CosmosDB
{
    public class CosmosDBEventSourceInstanceDataSource : IPersistableEventSourceInstanceDataStore
    {
        ...
        private readonly ILogger<CosmosDBEventSourceInstanceDataSource> _logger;
        private bool _initialized = false;

        public CosmosDBEventSourceInstanceDataSource(StateRepository stateRepository, CosmosDbInitializor initializor, ILogger<CosmosDBEventSourceInstanceDataSource> logger)
        {
        ...
        public async Task<dynamic> LoadState()
        {
            ...
            {
                _logger.LogError(e, "Failed to load state");
