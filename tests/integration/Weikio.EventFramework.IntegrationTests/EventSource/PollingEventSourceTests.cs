...
namespace Weikio.EventFramework.IntegrationTests.EventSource
{
    ...
    public class PollingEventSourceTests : PollingEventSourceTestBase, IDisposable
    {
        ...
        [Fact]
        public Task CanCreateInstanceInConfigure()
        {
            var serviceProvider = Init(services =>
            {
                services.AddCloudEventSources();
        ...
        [Fact]
        public Task CanConfigureEventCreationOptions()
        {
        ...
        [Fact]
        public Task CanConfigureEventTypeSpecificEventCreationOptions()
        {
            throw new NotImplementedException();
            // var serviceProvider = Init(services =>
            // {
        ...
        [Fact]
        public Task CanConfigureEventTypeSpecificEventCreationOptionsForInstance()
        {
            throw new NotImplementedException();
        ...
        [Fact]
        public Task CanOverrideEventTypeSpecificEventCreationOptionsForInstance()
        {
            throw new NotImplementedException();
            //
            // var serviceProvider = Init(services =>
        ...
        [Fact]
        public Task CanConfigureInstanceSpecificCreationOptions()
        {
            throw new NotImplementedException();
            // var serviceProvider = Init(services =>
            // {
        ...
        [Fact]
        public Task CanOverrideDefaultEventCreationOptions()
        {
            throw new NotImplementedException();
            // var serviceProvider = Init(services =>
            // {
        ...
        [Fact]
        public Task EventContainsEventSourceIdWithPublisherConfiguration()
        {
            throw new NotImplementedException();
            //
            // var serviceProvider = Init(services =>
