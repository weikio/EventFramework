        ...
        public async Task NewEventSource()
        {
            ...
            var options = new EventSourceInstanceOptions()
            {
                ...
                Configuration = new AzureServiceBusCloudEventSourceConfiguration()
                {
                    ...
                    ConnectionString =
                        "Endpoint=sb://adafy-weikio-dev.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=YZ4SEjbtsMD/We36RbVOHe29Je4ynZ8vIsb5DcvmuL4="
                },
                Autostart = true,
            };
